...
class Model(nn.Module):
    ...
    def forward(self, batch, mode):
        ...
        """ The "Query Attention Guided Inference" module, use in eval.
        ...
        if mode == 'train':
            def get_gaussian_weight(video_mask, glance_frame):
                ...
                x = torch.linspace(-1, 1, steps=L).view(1, L).expand(B, L).cuda()
            ...
            res = torch.nn.utils.rnn.pad_sequence(res, batch_first=True).cuda()
